...
public class EditProfileActivity extends Activity {
	private final static String DEBUG_TAG = "EditProfileActivity";
	...
	private final String CALLBACKURL = "socprox-app://profile";	//this will need to be whatever View we went to switch to once the person logs in.
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        if(names.length==2) {
	        ((EditText)findViewById(R.id.et_firstname)).setText(names[0]);
	        ((EditText)findViewById(R.id.et_lastname)).setText(names[1]);
        }
        
        if(null != User.email && "null" != User.email) {
        	((EditText)findViewById(R.id.et_email)).setText(User.email);
        }
    ...
    public void onSaveButtonClicked(View v){
    	//check first and last name fields, make API call, then return to GameStats.
    	...
    	String call = RESTCaller.updateProfile(socproxUsername, firstName, lastName, email);
    	executeREST(call);
    	
    }
    
    public void onCloseButtonClicked(View v) {
    	startActivity(new Intent(EditProfileActivity.this, GameActivity.class));
    }
    ...
    //==============================================================================
  	...
  	void twitterConnect() {
  		try {
  			...
  			Log.e("in EditProfileActivity.twitterConnect", ex.getMessage());
  		}
  	}
  	...
  	protected void onNewIntent(Intent intent) {
  		...
  		try {
  			...
  			Log.e("EditProfileActivity.onNewIntent", "" + ex.getMessage());
